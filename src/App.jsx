...
function App() {
  ...
  const handleCalculate=(e)=>{
    ...
    if (principle && rate && year) {
      ...
      alert('plz fill the form completly')
    }
      ...
      <div style={{ width: "100%", minHeight: "100vh" }} className='d-flex justify-content-center align-items-center bg-dark'>
        <div className='bg-light p-5 rounded'>
          ...
          <form className='mt-5'>
            ...
            {invalidPrinciple && <div className='text-danger fw-bolder'>*Invalid Principle Amount</div>}
            ...
            {invalidRate && <div className='text-danger fw-bolder'>*Invalid Rate of interst</div>}
            ...
            {invalidYear && <div className='text-danger fw-bolder'>*Invalid time period</div>}
